...
def export_gantt_to_msproject_csv(markdown_path, output_csv_path):
    ...
    # Optionally, rename columns to match MS Project expectations
    # For example: Task Name, Start, Finish, Duration, Predecessors, etc.
    # You may need to adjust this mapping based on your parse_gantt_chart output
    column_map = {
        'Task Name': 'Task Name',
        'Start Date': 'Start',
        'End Date': 'Finish',
